...
--
-- This file contains initial seed data for the bucket.file_shares table.
-- Customize this file to add your initial data.

-- INSERT INTO bucket.file_shares (
--     id,
--     file_id,
--     owner_id,
--     token,
...
-- INSERT INTO bucket.file_shares (id, code, name, is_active, created_at, updated_at) VALUES
