...
This directory contains documentation for the bucket bounded context module.
...
backbone schema generate bucket --target docs

# Generate OpenAPI spec only
backbone schema generate bucket --target openapi
```

## Module Overview

**Bounded Context:** bucket
