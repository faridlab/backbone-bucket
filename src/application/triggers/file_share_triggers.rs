...
pub type FileShareTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<FileShare>, TriggerEvent>;
...
impl TriggerHandler<FileShareTriggerContext, FileShareTriggerEvent> for FileShareOnEnterExhaustedHandler {
    fn events(&self) -> Vec<FileShareTriggerEvent> {
        vec![TriggerEvent::OnEnterState("exhausted".to_string())]
    }
...
/// Create a default registry pre-populated with all handlers for FileShare.
