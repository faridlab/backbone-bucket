...
pub type ConversionJobTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<ConversionJob>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for ConversionJob.
