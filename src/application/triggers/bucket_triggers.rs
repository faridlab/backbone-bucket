...
pub type BucketTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<Bucket>, TriggerEvent>;
...
impl TriggerHandler<BucketTriggerContext, BucketTriggerEvent> for BucketOnEnterReadonlyHandler {
    fn events(&self) -> Vec<BucketTriggerEvent> {
        vec![TriggerEvent::OnEnterState("readonly".to_string())]
    }
...
impl TriggerHandler<BucketTriggerContext, BucketTriggerEvent> for BucketOnEnterArchivedHandler {
    fn events(&self) -> Vec<BucketTriggerEvent> {
        vec![TriggerEvent::OnEnterState("archived".to_string())]
    }
...
/// Create a default registry pre-populated with all handlers for Bucket.
