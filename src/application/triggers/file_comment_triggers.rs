...
pub type FileCommentTriggerHandlerObj =
    dyn TriggerHandler<TriggerContext<FileComment>, TriggerEvent>;
...
/// Create a default registry pre-populated with all handlers for FileComment.
