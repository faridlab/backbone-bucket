//! Permission guard for StoredFile
//!
...
struct StoredFileRoleRules {
    allowed_actions: HashSet<Action>,
    denied_actions: HashSet<Action>,
    field_restrictions: HashMap<Action, FieldRestriction>,
}

/// Permission guard for StoredFile resources
#[derive(Debug, Clone)]
pub struct StoredFilePermissions {
    rules: HashMap<String, StoredFileRoleRules>,
}

impl StoredFilePermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = StoredFileRoleRules::default();
        ...
        // admin role
        {
            ...
            // TODO: Custom action 'quarantine' - implement separately
            // TODO: Custom action 'mark_safe' - implement separately
...
impl Default for StoredFilePermissions {
    fn default() -> Self {
        Self::new()
    }
}

impl PermissionChecker for StoredFilePermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = StoredFilePermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = StoredFilePermissions::new();
    }
