...
impl BucketPermissions {
    ...
    pub fn new() -> Self {
        ...
        // super_admin role
        {
            let mut role_perms = BucketRoleRules::default();
        ...
        // admin role
        {
            ...
            // TODO: Custom action 'lock' - implement separately
            // TODO: Custom action 'unlock' - implement separately
...
impl PermissionChecker for BucketPermissions {
...
mod tests {
    ...
    fn test_create_permissions() {
        let perms = BucketPermissions::new();
    ...
    fn test_super_admin_role() {
        let _perms = BucketPermissions::new();
    }
