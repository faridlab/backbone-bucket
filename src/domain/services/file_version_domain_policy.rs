//! Domain policy for FileVersion aggregate
//!
...
/// Domain policy for FileVersion — permits all operations (no business invariants).
///
/// To add domain rules, replace this alias with a struct implementing
/// `backbone_core::DomainPolicy<FileVersion>` in the `// <<< CUSTOM` zone.
pub type FileVersionDomainPolicy = PermitAllPolicy<FileVersion>;
