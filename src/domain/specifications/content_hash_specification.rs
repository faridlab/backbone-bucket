//! Specifications for ContentHash aggregate
//!
...
// Each predicate implements `Specification<ContentHash>` and can be combined
...
//
// pub struct ActiveContentHashSpec;
// impl Specification<ContentHash> for ActiveContentHashSpec {
//     fn is_satisfied_by(&self, e: &ContentHash) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
