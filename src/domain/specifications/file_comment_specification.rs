//! Specifications for FileComment aggregate
//!
...
// Each predicate implements `Specification<FileComment>` and can be combined
...
//
// pub struct ActiveFileCommentSpec;
// impl Specification<FileComment> for ActiveFileCommentSpec {
//     fn is_satisfied_by(&self, e: &FileComment) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
...
// pub struct FileCommentHasValidEmailSpec;
// impl FileCommentSpecification for FileCommentHasValidEmailSpec {
//     fn is_satisfied_by(&self, entity: &FileComment) -> bool {
