//! Specifications for ConversionJob aggregate
//!
...
// Each predicate implements `Specification<ConversionJob>` and can be combined
...
//
// pub struct ActiveConversionJobSpec;
// impl Specification<ConversionJob> for ActiveConversionJobSpec {
//     fn is_satisfied_by(&self, e: &ConversionJob) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
...
// pub struct ConversionJobHasValidEmailSpec;
// impl ConversionJobSpecification for ConversionJobHasValidEmailSpec {
//     fn is_satisfied_by(&self, entity: &ConversionJob) -> bool {
