//! Specifications for FileVersion aggregate
//!
...
// Each predicate implements `Specification<FileVersion>` and can be combined
...
//
// pub struct ActiveFileVersionSpec;
// impl Specification<FileVersion> for ActiveFileVersionSpec {
//     fn is_satisfied_by(&self, e: &FileVersion) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
...
// pub struct FileVersionHasValidEmailSpec;
// impl FileVersionSpecification for FileVersionHasValidEmailSpec {
//     fn is_satisfied_by(&self, entity: &FileVersion) -> bool {
