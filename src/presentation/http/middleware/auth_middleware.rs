...
pub async fn api_version_middleware(
    ...
    // Path could contain characters invalid for headers, use fallback
    let header_value = HeaderValue::from_str(version)
...
pub async fn security_headers(
    ...
    // Security headers - using from_static for compile-time validated strings
    headers.insert(
