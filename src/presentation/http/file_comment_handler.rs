...
#[cfg(feature = "auth")]
pub fn create_protected_file_comment_routes<A: AuthMiddleware + 'static>(
...
pub async fn resolve_transition(
    ...
    #[cfg(feature = "auth")]
    {
        ...
        let has_specific_perm = auth.has_permission("file_comment:transition:resolve");
        let has_update_perm = auth.has_permission("file_comment:update");
...
pub async fn edit_transition(
    ...
    #[cfg(feature = "auth")]
    {
        ...
        let has_specific_perm = auth.has_permission("file_comment:transition:edit");
        let has_update_perm = auth.has_permission("file_comment:update");
        let has_role = auth.roles.iter().any(|r| allowed_roles.contains(&r.as_str()));
        if !has_specific_perm && !has_update_perm && !has_role {
...
pub async fn delete_active_transition(
    ...
    #[cfg(feature = "auth")]
    {
        ...
        let has_specific_perm = auth.has_permission("file_comment:transition:delete_active");
        let has_update_perm = auth.has_permission("file_comment:update");
        let has_role = auth.roles.iter().any(|r| allowed_roles.contains(&r.as_str()));
        if !has_specific_perm && !has_update_perm && !has_role {
...
pub async fn reopen_transition(
    ...
    #[cfg(feature = "auth")]
    {
        ...
        let has_specific_perm = auth.has_permission("file_comment:transition:reopen");
        let has_update_perm = auth.has_permission("file_comment:update");
        let has_role = auth.roles.iter().any(|r| allowed_roles.contains(&r.as_str()));
        if !has_specific_perm && !has_update_perm && !has_role {
...
pub async fn delete_resolved_transition(
    ...
    #[cfg(feature = "auth")]
    {
        ...
        let has_specific_perm = auth.has_permission("file_comment:transition:delete_resolved");
        let has_update_perm = auth.has_permission("file_comment:update");
        let has_role = auth.roles.iter().any(|r| allowed_roles.contains(&r.as_str()));
        if !has_specific_perm && !has_update_perm && !has_role {
